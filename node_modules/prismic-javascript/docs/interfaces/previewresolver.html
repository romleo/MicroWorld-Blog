...
<head>
	...
	<title>PreviewResolver | prismic-javascript</title>
	...
	<div class="tsd-page-title">
		<div class="container">
			<ul class="tsd-breadcrumb">
				...
				<li>
					<a href="previewresolver.html">PreviewResolver</a>
				</li>
			</ul>
			<h1>Interface PreviewResolver</h1>
		</div>
	</div>
</header>
		...
		<div class="col-8 col-content">
			<section class="tsd-panel tsd-hierarchy">
				...
				<ul class="tsd-hierarchy">
					<li>
						<span class="target">PreviewResolver</span>
					</li>
				</ul>
			</section>
					...
					<div class="tsd-index-content">
						<section class="tsd-index-section tsd-is-external">
							...
							<ul class="tsd-index-list">
								<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-external"><a href="previewresolver.html#documentid" class="tsd-kind-icon">document<wbr>Id</a></li>
								<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-external"><a href="previewresolver.html#token" class="tsd-kind-icon">token</a></li>
							</ul>
						</section>
						<section class="tsd-index-section tsd-is-external">
							<h3>Methods</h3>
							<ul class="tsd-index-list">
								<li class="tsd-kind-method tsd-parent-kind-interface tsd-is-external"><a href="previewresolver.html#resolve" class="tsd-kind-icon">resolve</a></li>
							</ul>
						</section>
					</div>
				</section>
			...
			<section class="tsd-panel-group tsd-member-group tsd-is-external">
				...
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface tsd-is-external">
					<a name="documentid" class="tsd-anchor"></a>
					<h3><span class="tsd-flag ts-flagOptional">Optional</span> document<wbr>Id</h3>
					<div class="tsd-signature tsd-kind-icon">document<wbr>Id<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">undefined</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">string</span></div>
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/prismicio/prismic-javascript/blob/291fd8b/src/ResolvedApi.ts#L19">ResolvedApi.ts:19</a></li>
						</ul>
					</aside>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface tsd-is-external">
					...
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/prismicio/prismic-javascript/blob/291fd8b/src/ResolvedApi.ts#L18">ResolvedApi.ts:18</a></li>
						</ul>
					</aside>
				</section>
			</section>
			...
			<nav class="tsd-navigation secondary menu-sticky">
				...
				<ul class="current">
					<li class="current tsd-kind-interface tsd-is-external">
						<a href="previewresolver.html" class="tsd-kind-icon">Preview<wbr>Resolver</a>
						<ul>
							<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-external">
								<a href="previewresolver.html#documentid" class="tsd-kind-icon">document<wbr>Id</a>
							</li>
							<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-external">
								<a href="previewresolver.html#token" class="tsd-kind-icon">token</a>
							</li>
							<li class=" tsd-kind-method tsd-parent-kind-interface tsd-is-external">
								<a href="previewresolver.html#resolve" class="tsd-kind-icon">resolve</a>
							</li>
						</ul>
					</li>
				</ul>
